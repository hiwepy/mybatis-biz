...
import org.apache.ibatis.utils.uid.SystemClock;
...
public class MybatisMapperRefresh implements Runnable {
	...
	public void run() {
		final MybatisContext context = MybatisContext.getBindContext(configuration);
		/*
		 * 启动 XML 热加载
		 */
		if (enabled) {
			...
			}, "Mybatis-enhanced MapperRefresh").start();
		}
	}
