...
import org.apache.ibatis.jdbc.MybatisTransactSQLBuilder;
import org.apache.ibatis.jdbc.enums.SqlLike;
...
public abstract class Wrapper<T> implements Serializable {
     ...
     * 实现了TSQL语法的SQL实体
     */
    protected MybatisTransactSQLBuilder transactSQL = new MybatisTransactSQLBuilder();
    ...
    public Wrapper<T> where(String sqlWhere, Object... params) {
        transactSQL.WHERE(formatSql(sqlWhere, params));
        return this;
    }
    ...
    public Wrapper<T> eq(String column, Object params) {
        transactSQL.WHERE(formatSql(String.format("%s = {0}", column), params));
        return this;
    }
        ...
        if (MapUtils.isNotEmpty(params)) {
            ...
            while (iterator.hasNext()) {
                ...
                if(StringUtils.checkValNotNull(value)){
                    transactSQL.WHERE(formatSql(String.format("%s = {0}", entry.getKey()), entry.getValue()));
                }
    ...
    public Wrapper<T> and(String sqlAnd, Object... params) {
        transactSQL.AND().WHERE(formatSql(sqlAnd, params));
        return this;
    }
    ...
    public Wrapper<T> andNew(String sqlAnd, Object... params) {
        transactSQL.AND_NEW().WHERE(formatSql(sqlAnd, params));
        return this;
    }
    ...
    public Wrapper<T> or(String sqlOr, Object... params) {
        transactSQL.OR().WHERE(formatSql(sqlOr, params));
        return this;
    }
    ...
    public Wrapper<T> orNew(String sqlOr, Object... params) {
        transactSQL.OR_NEW().WHERE(formatSql(sqlOr, params));
        return this;
    }
    ...
    public Wrapper<T> having(String sqlHaving, Object... params) {
        transactSQL.HAVING(formatSql(sqlHaving, params));
        return this;
    }
    ...
    public Wrapper<T> orderBy(String columns, boolean isAsc) {
        if (StringUtils.isNotEmpty(columns)) {
            transactSQL.ORDER_BY(columns + (isAsc ? " ASC" : " DESC"));
        }
        return this;
    }
    ...
    public Wrapper<T> like(String column, String value) {
        transactSQL.LIKE(column, value, SqlLike.DEFAULT);
        return this;
    }
    ...
    public Wrapper<T> notLike(String column, String value) {
        transactSQL.NOT_LIKE(column, value, SqlLike.DEFAULT);
        return this;
    }
    /**
     * LIKE条件语句，value中无需前后%
    ...
    public Wrapper<T> like(String column, String value, SqlLike type) {
        transactSQL.LIKE(column, value,type);
        return this;
    }
    ...
    public Wrapper<T> notLike(String column, String value, SqlLike type) {
        transactSQL.NOT_LIKE(column, value,type);
        return this;
    }
    ...
    public Wrapper<T> isNotNull(String columns) {
        transactSQL.IS_NOT_NULL(columns);
        return this;
    }
    ...
    public Wrapper<T> notIn(String column, String value) {
        transactSQL.NOT_IN(column, value);
        return this;
    }
    ...
    public Wrapper<T> in(String column, Object[] value) {
        transactSQL.IN(column, Arrays.asList(value));
        return this;
    }
    ...
    public Wrapper<T> notIn(String column, Object... value) {
        transactSQL.NOT_IN(column, Arrays.asList(value));
        return this;
    }
    ...
    public Wrapper<T> between(String column, String val1, String val2) {
        transactSQL.BETWEEN_AND(column, val1, val2);
        return this;
    }
