...
public class MybatisTransactSQLBuilder extends MybatisAbstractSQL<MybatisTransactSQLBuilder> {
	...
	@Override
	public MybatisTransactSQLBuilder getSelf() {
		return this;
	}
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder LIKE(String column, String value, SqlLike type) {
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder NOT_LIKE(String column, String value, SqlLike type) {
	 ...
	 * @return this
	 */
	public MybatisTransactSQLBuilder IS_NOT_NULL(String columns) {
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder IS_NULL(String columns) {
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder IN(String column, Collection<?> value) {
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder NOT_IN(String column, Collection<?> value) {
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder IN(String column, String value) {
		handerIn(column, value, false);
		return this;
	}
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder NOT_IN(String column, String value) {
		handerIn(column, value, true);
		return this;
	}
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder EXISTS(String value) {
	 ...
	 * @return
	 */
	public MybatisTransactSQLBuilder NOT_EXISTS(String value) {
	 ...
	 * @param val2
	 */
	public MybatisTransactSQLBuilder BETWEEN_AND(String column, String val1, String val2) {
