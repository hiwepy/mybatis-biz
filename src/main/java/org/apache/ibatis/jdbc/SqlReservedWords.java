...
public class SqlReservedWords {
	 ...
	 * 数据库字段转义
	 * </p>
	 * @param definition 全局配置
	 * @param column 数据库字段
	 * @return
	 */
	public static String convert(MybatisContext definition, String column) {
		if (containsWord(column)) {
			String identifierQuote = StringUtils.isEmpty(definition.getIdentifierQuote()) ? definition.getDatabaseType().getQuote()
					: definition.getIdentifierQuote();
